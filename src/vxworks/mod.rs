...
impl crate::Copy for _Vx_semaphore {}
impl crate::Clone for _Vx_semaphore {
...
s_no_extra_traits! {
    ...
    pub union sa_u_t {
        pub sa_handler: crate::Option<unsafe extern "C" fn(c_int) -> !>,
        pub sa_sigaction:
            crate::Option<unsafe extern "C" fn(c_int, *mut crate::siginfo_t, *mut c_void) -> !>,
    }
