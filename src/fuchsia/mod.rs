...
impl crate::Copy for fpos64_t {}
impl crate::Clone for fpos64_t {
...
s! {
    ...
    pub struct sigaction {
        ...
        pub sa_flags: c_int,
        pub sa_restorer: crate::Option<extern "C" fn()>,
    }
...
#[cfg_attr(feature = "extra_traits", derive(Debug))]
pub enum FILE {}
impl crate::Copy for FILE {}
impl crate::Clone for FILE {
    fn clone(&self) -> FILE {
        *self
    }
}
...
impl crate::Copy for fpos_t {}
impl crate::Clone for fpos_t {
...
extern "C" {
    ...
    pub fn pthread_key_create(
        ...
        dtor: crate::Option<unsafe extern "C" fn(*mut c_void)>,
    ) -> c_int;
