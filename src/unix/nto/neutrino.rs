...
s! {
    ...
    pub struct _sighandler_info {
        ...
        pub handler: crate::Option<unsafe extern "C" fn(value: c_int)>,
...
extern "C" {
    ...
    pub fn InterruptHookTrace(
        __handler: crate::Option<unsafe extern "C" fn(arg1: c_int) -> *const crate::sigevent>,
        __flags: c_uint,
    ) -> c_int;
    pub fn InterruptHookIdle(
        __handler: crate::Option<unsafe extern "C" fn(arg1: *mut u64, arg2: *mut qtime_entry)>,
        __flags: c_uint,
    ) -> c_int;
    pub fn InterruptHookIdle2(
        __handler: crate::Option<
