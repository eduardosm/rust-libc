...
pub enum timezone {}
impl crate::Copy for timezone {}
impl crate::Clone for timezone {
...
#[cfg_attr(feature = "extra_traits", derive(Debug))]
pub enum ucred_t {}
impl crate::Copy for ucred_t {}
impl crate::Clone for ucred_t {
...
impl crate::Copy for siginfo_fault {}
impl crate::Clone for siginfo_fault {
    fn clone(&self) -> Self {
        *self
    }
}
...
impl crate::Copy for siginfo_cldval {}
impl crate::Clone for siginfo_cldval {
    fn clone(&self) -> Self {
        *self
    }
}
...
impl crate::Copy for siginfo_killval {}
impl crate::Clone for siginfo_killval {
    fn clone(&self) -> Self {
        *self
    }
}
...
impl crate::Copy for siginfo_sigcld {}
impl crate::Clone for siginfo_sigcld {
    fn clone(&self) -> Self {
        *self
    }
}
...
impl crate::Copy for siginfo_kill {}
impl crate::Clone for siginfo_kill {
    fn clone(&self) -> Self {
        *self
    }
}
...
impl siginfo_t {
    unsafe fn sidata<T: crate::Copy>(&self) -> T {
...
extern "C" {
    ...
    pub fn glob(
        ...
        flags: c_int,
        errfunc: crate::Option<extern "C" fn(epath: *const c_char, errno: c_int) -> c_int>,
    ...
    pub fn pthread_atfork(
        prepare: crate::Option<unsafe extern "C" fn()>,
        parent: crate::Option<unsafe extern "C" fn()>,
        child: crate::Option<unsafe extern "C" fn()>,
    ) -> c_int;
