...
s! {
    ...
    pub struct malloc_zone_t {
        ...
        >,
        pub valloc: crate::Option<
            unsafe extern "C" fn(zone: *mut malloc_zone_t, size: size_t) -> *mut c_void,
        >,
        pub free: crate::Option<unsafe extern "C" fn(zone: *mut malloc_zone_t, ptr: *mut c_void)>,
        pub realloc: crate::Option<
            unsafe extern "C" fn(
                zone: *mut malloc_zone_t,
                ptr: *mut c_void,
                size: size_t,
        ...
        >,
        pub destroy: crate::Option<unsafe extern "C" fn(zone: *mut malloc_zone_t)>,
        pub zone_name: *const c_char,
        pub batch_malloc: crate::Option<
            unsafe extern "C" fn(
                zone: *mut malloc_zone_t,
                size: size_t,
        ...
        >,
        pub free_definite_size: crate::Option<
            unsafe extern "C" fn(zone: *mut malloc_zone_t, ptr: *mut c_void, size: size_t),
        >,
        pub pressure_relief:
            crate::Option<unsafe extern "C" fn(zone: *mut malloc_zone_t, goal: size_t) -> size_t>,
        pub claimed_address: crate::Option<
